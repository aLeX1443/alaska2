...
from tensorflow.config import EXPERIMENT_HYPER_PARAMETERS
from data_loaders import create_train_and_validation_loaders
from utils import load_trained_tf_model
...
def get_compiled_model(hyper_parameters):
    ...
    # Compile the model.
    model.compile(
        optimizer=optimiser, loss="binary_crossentropy", metrics=metrics,
    )
